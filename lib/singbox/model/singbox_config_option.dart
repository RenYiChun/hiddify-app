...
class SingboxConfigOption with _$SingboxConfigOption {
  ...
  const factory SingboxConfigOption({
    ...
    required bool enableProcessStableProxyRules,
    required List<String> processStableProxyRuleNames,
    required List<String> processStableProxyExcludedOutboundKeywords,
