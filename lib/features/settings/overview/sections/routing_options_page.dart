              ...
              children: [
                ...
                ListTile(
                  ...
                  onTap: () => Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => const ProcessDirectRulesPage(), fullscreenDialog: true),
                  ),
                ),
                SwitchListTile.adaptive(
                ...
                ListTile(
                  ...
                  onTap: () => Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => const ProcessStableProxyRulesPage(),
                      fullscreenDialog: true,
                    ),
                  ),
                ),
                SwitchListTile.adaptive(
                  title: const Text('启用动态直连旁路'),
                  secondary: const Icon(Icons.alt_route_rounded),
                  value: ref.watch(ConfigOptions.enableDynamicDirectBypass),
                  onChanged: ref.read(ConfigOptions.enableDynamicDirectBypass.notifier).update,
                ),
                ValuePreferenceWidget(
                  title: '动态直连旁路 TTL',
                  icon: Icons.timer_outlined,
                  value: ref.watch(ConfigOptions.dynamicDirectBypassTtl),
                  preferences: ref.watch(ConfigOptions.dynamicDirectBypassTtl.notifier),
                  presentValue: (value) => value.toApproximateTime(isRelativeToNow: false),
                  formatInputValue: (value) => value.inHours.toString(),
                  validateInput: (value) {
                  ...
                  inputToValue: (value) {
                    final hours = int.tryParse(value);
                    return hours != null && hours > 0 ? Duration(hours: hours) : null;
                  },
                  digitsOnly: true,
                ),
                ValuePreferenceWidget(
                  ...
                  value: ref.watch(ConfigOptions.dynamicDirectBypassMaxRoutes),
                  preferences: ref.watch(ConfigOptions.dynamicDirectBypassMaxRoutes.notifier),
                  digitsOnly: true,
                  validateInput: (value) {
                    final routes = int.tryParse(value);
                    return routes != null && routes > 0;
                  },
                  inputToValue: (value) {
                    final routes = int.tryParse(value);
                    return routes != null && routes > 0 ? routes : null;
                  },
                ),
                ValuePreferenceWidget(
                  title: '动态直连旁路单主机上限',
                  icon: Icons.hub_outlined,
                  value: ref.watch(ConfigOptions.dynamicDirectBypassMaxRoutesPerHost),
                  preferences: ref.watch(ConfigOptions.dynamicDirectBypassMaxRoutesPerHost.notifier),
                  digitsOnly: true,
                  validateInput: (value) {
                    final routes = int.tryParse(value);
                    return routes != null && routes > 0;
