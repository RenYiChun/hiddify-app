...
[UninstallDelete]
Type: filesandordirs; Name: "{userappdata}\RenYiChun\HiddifyCustom"
...
var
  ResultCode: Integer;
begin
  Exec('taskkill', '/F /IM HiddifyCustom.exe', '', SW_HIDE, ewWaitUntilTerminated, ResultCode)
  Exec('net', 'stop "HiddifyCustomTunnelService"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode)
  Exec('sc.exe', 'delete "HiddifyCustomTunnelService"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode)
  Result := True;
end;
